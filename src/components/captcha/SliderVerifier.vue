<template>
  <div class="p-0.5" v-loading="props.loading">
    <div style="width: 300px;margin: 0 auto" class="relative">
        <span class="absolute top-1 right-2 cursor-pointer" @click="emits('reload')">
          <el-icon size="20"><Refresh /></el-icon>
        </span>
      <img class="w-[300px] h-[150px]" :src="captchaImages[0]" alt="" />
      <img class="w-[60px] h-[60px] chunk" :src="captchaImages[1]" alt="" ref="chunk" :style="chunkPos" />
      <div class="mt-2 slider-container bg-gray-200 dark:bg-gray-900">
        <div class="prompt-text">
          {{ prompt }}
        </div>
        <div ref="slider"
             class="slider bg-gray-100 dark:bg-gray-800"
