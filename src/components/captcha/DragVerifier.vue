<template>
  <div class="slider-verification rounded bg-blue-600 dark:bg-gray-700" ref="sliderContainer">
    <div class="slider-left-bg rounded bg-blue-800 dark:bg-gray-900" :style="sliderLeftWidthStyle"></div>
    ...
    <div ref="slider"
         :class="{'slider-verify-success':verifySuccess,'rounded-r':verifySuccess}"
         class="slider rounded-l bg-blue-500 dark:bg-gray-800"
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const stopClientX = ref(0)
    const beginTime = ref(0)
    const endTime = ref(0)
    const maxWidth = ref(0)
    const points = ref<number[][]>([])
    const slideWidth = ref(0)// 拖动宽度
